...
class LepEff:public EffCorrClass{
    private:
    TH2F*** hEntries;
    ...
    float weight(int lep_gen, int exp_no, float theta, float plep, int iVarBin=0, int iNoError = 0, float evntWeight =1.);
    float weightError(int lep_gen, int exp_no, float theta, float plep);
